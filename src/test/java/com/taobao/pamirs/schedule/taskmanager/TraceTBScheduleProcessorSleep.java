...
public class TraceTBScheduleProcessorSleep<T> implements IScheduleProcessor, Runnable {
     ...
     * @throws Exception
     */
    public TraceTBScheduleProcessorSleep(TBScheduleManager aManager,
                                         IScheduleTaskDeal<T> aTaskDealBean, StatisticsInfo aStatisticsInfo, String traceId) throws Exception {
